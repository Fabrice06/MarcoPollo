(function () {
    ...
    function Session(Crypto) {
        ...
        return {
            ...
            getSignature: function (pUrl, pDatas, pTimestamp) {

                var nUri = pUrl + "?user=" + nSession['id'] + "&timestamp=" + pTimestamp + "&" + pDatas;
                ...
                console.log("Session factory getSignature uri " + nUri);
